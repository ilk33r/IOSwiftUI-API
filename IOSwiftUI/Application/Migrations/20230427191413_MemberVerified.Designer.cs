...
namespace IOSwiftUI.Application.Migrations
{
    ...
    [Migration("20230427191413_MemberVerified")]
    partial class MemberVerified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.IOBackOfficeMessageEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.IOClientsEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.IOConfigurationEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.IOImagesEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.IOMenuEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.IOUserEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Password = "$IOPSSWD$V1$10000$iF2eGK9pta12h/NXjo05ASI63DcTchHow0KFST2fw/hOsIYpylKOsBIgqvFLRX7ZEmSNfQg5Ymgc7SgQFHrbQQM1uhC4ymDRC0/kJJXY4MzrKHqLT4I9wSLh3e1WEaBk",
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.PushNotificationDeliveredMessagesEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.PushNotificationEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.PushNotificationMessageEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOSwiftUI.DataAccess.Entities.InboxEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOSwiftUI.DataAccess.Entities.MemberEntity", b =>
                {
                    ...
                    b.Property<string>("DeviceManifacturer")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("varchar(32)");
                    ...
                    b.Property<string>("MRZFullString")
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");
            ...
            modelBuilder.Entity("IOSwiftUI.DataAccess.Entities.MemberFaceIDEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset>("PairDate")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("IOSwiftUI.DataAccess.Entities.MessageEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IOSwiftUI.DataAccess.Entities.OneTimeCodeEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset?>("ValidateDate")
                        .HasColumnType("DATETIME");
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.PushNotificationDeliveredMessagesEntity", b =>
                {
                    b.HasOne("IOBootstrap.NET.DataAccess.Entities.PushNotificationEntity", "PushNotification")
                        .WithMany("DeliveredMessages")
                        .HasForeignKey("PushNotificationID");

                    b.HasOne("IOBootstrap.NET.DataAccess.Entities.PushNotificationMessageEntity", "PushNotificationMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.PushNotificationEntity", b =>
                {
                    b.HasOne("IOBootstrap.NET.DataAccess.Entities.IOClientsEntity", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("IOBootstrap.NET.DataAccess.Entities.PushNotificationMessageEntity", b =>
                {
                    ...
                    b.HasOne("IOBootstrap.NET.DataAccess.Entities.PushNotificationEntity", "PushNotificationDeviceID")
                        .WithMany()
            ...
            modelBuilder.Entity("IOSwiftUI.DataAccess.Entities.InboxEntity", b =>
                {
                    b.HasOne("IOSwiftUI.DataAccess.Entities.MemberEntity", "FromMember")
                        .WithMany()
                        .HasForeignKey("FromMemberID");

                    b.HasOne("IOSwiftUI.DataAccess.Entities.MessageEntity", "LastMessage")
                        .WithMany()
                        .HasForeignKey("LastMessageID");

                    b.HasOne("IOSwiftUI.DataAccess.Entities.MemberEntity", "ToMember")
                        .WithMany()
            ...
            modelBuilder.Entity("IOSwiftUI.DataAccess.Entities.MessageEntity", b =>
                {
                    ...
                    b.HasOne("IOSwiftUI.DataAccess.Entities.InboxEntity", null)
                        .WithMany("Messages")
